...
public class ZipModelZstdTest extends AbstractModelTest {
	...
	public ContentTypeId getArchiveType() {
		return ContentTypeId.ZIP_ZSTD_FILE;
	}
	...
	public void shouldOpenNodes() throws Exception {
		...
		preferenceStore.setValue(PreferenceConstants.PREFIX_EDITOR + PreferenceConstants.SELECTED_ZSTD_LIB, PreferenceUtils.AIRCOMPRESSOR_ID);
	...
	public void extractZstdNode1() throws IOException {
		...
		.setValue(PreferenceConstants.PREFIX_EDITOR + PreferenceConstants.SELECTED_ZSTD_LIB, PreferenceUtils.AIRCOMPRESSOR_ID);

		assertTrue(PreferenceUtils.isAircompressorSelected());
		assertFalse(PreferenceUtils.isJNIZstdSelected());
		ZipEditorPlugin.getDefault().getPreferenceStore()
				.setValue(PreferenceConstants.PREFIX_EDITOR + PreferenceConstants.SELECTED_ZSTD_LIB, PreferenceUtils.JNI_LIBRARY_ID);
